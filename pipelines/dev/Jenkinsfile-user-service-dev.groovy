            ...
            steps {
                dir(SERVICE_DIR) {
                    script {
                        ...
                        // Trivy Security Scan (después de construir la imagen)
                        sh '''
                            # Construir imagen temporalmente para escanear
            ...
            steps {
                script {
                    sh '''
                        ...
                        kubectl create namespace ${MINIKUBE_NAMESPACE} --dry-run=client -o yaml | kubectl apply -f -
                    '''
                }
            }
        }
            ...
            steps {
                script {
                    sh '''
                        ...
                        # Verificar que el puerto es el correcto
